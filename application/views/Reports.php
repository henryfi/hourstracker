  ...
  <div class="row">
    <div class="col-lg-5">
      <div class="panel panel-default">
        ...
        <div class="panel-heading">Projects to include (defaults to all)</div>
        <table class="table">
          <tr ng-repeat="project in projects">
            <td style="width:30px;">
              <input type="checkbox" name="projects[]" value="{{project.id}}" checklist-model="selectedProjects" checklist-value="project.id">
            </td>
            <td>
              {{project.name}}
            </td>
    ...
    <div class="col-lg-5">
      <div class="panel panel-default">
        <!-- Default panel contents -->
        <div class="panel-heading">Users to include (defaults to all)</div>
        <table class="table">
